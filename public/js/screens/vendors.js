...
const VendorsScreen = {
    ...
    el.innerHTML = `
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ${this.summary.length === 0 ? `<tr><td colspan="5"><div class="empty-state"><p>No vendor activity yet.</p></div></td></tr>` : this.summary.map(s => `
              <tr>
  ...
  openBillModal() {
    ...
    document.getElementById('bill-form').addEventListener('submit', async (e) => {
      e.preventDefault();
      const supplierId = document.getElementById('b-supplier').value;
  ...
  openPayModal(bill) {
    ...
    Modal.open('Pay Vendor Bill', `
      ...
      <form id="pay-form">
        <div class="form-group">
          <label class="form-label">Payment Amount (BHD)</label>
